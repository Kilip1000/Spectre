package dev.spiritstudios.spectre.api.serialization;
...
public final class SpectreCodecs {
	...
	// STUB
	public static final Codec<MolangExpression> MOLANG = Codec.FLOAT.xmap(
		v -> context -> v,
		function -> { throw new UnsupportedOperationException("Cannot encode molang expression."); }
	);
