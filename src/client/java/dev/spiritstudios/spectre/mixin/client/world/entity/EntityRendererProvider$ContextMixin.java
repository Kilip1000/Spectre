...
import dev.spiritstudios.spectre.impl.client.pond.SpectreInternalEntityRendererProvider$Context;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Unique;

@Mixin(EntityRendererProvider.Context.class)
public class EntityRendererProvider$ContextMixin implements SpectreEntityRendererProviderContext, SpectreInternalEntityRendererProvider$Context {
	@Unique
