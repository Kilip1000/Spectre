...
//
//	@Override
//	public void apply(Function<String, @Nullable ModelPart> lookup, Map<String, SpectreAnimationDefinition> animations, Query query, float time) {
//		var animation = animations.get(name);
//
//		animation.boneAnimations().forEach((name, anim) -> {
